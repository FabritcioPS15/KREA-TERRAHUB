                ...
                <div className="relative z-10 container mx-auto px-6 text-white text-center">
                    ...
                    <FadeIn direction="up">
                        ...
                        <p className="text-lg text-white/80 max-w-2xl mx-auto">
                            Noticias, tendencias y consejos sobre construcción y diseño.
                        </p>
                    </FadeIn>
                </div>
            </section>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-6">
                    <div className="text-center py-20">
                        <h2 className="text-2xl font-bold text-gray-400">Próximamente: Artículos y Noticias</h2>
                        <p className="text-gray-500 mt-2">Mantente al tanto de todas las novedades de la industria.</p>
                    </div>
                </div>
            </section>
        </div>
