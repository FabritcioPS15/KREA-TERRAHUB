        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <FadeIn direction="up">
            <h2 className="text-3xl md:text-4xl font-light tracking-tight leading-tight max-w-4xl mx-auto">
              Tu Hub Empresarial: <span className="font-semibold italic text-blue-400">Conectando Espacios</span> y <span className="font-semibold italic text-green-400">Calidad Natural</span>
            </h2>
          </FadeIn>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <FadeIn direction="up">
              ...
              <p className="text-xl text-slate-600 mb-10 leading-relaxed font-light">
                Somos un <span className="font-medium text-slate-800">hub empresarial innovador</span> que conecta dos sectores estratégicos: construcción y
                agroindustria. Ofrecemos soluciones constructivas integrales y productos agroindustriales de
                origen, comprometidos con la calidad, sostenibilidad y excelencia en cada proyecto.
              </p>
              <Link
                to="/nosotros"
