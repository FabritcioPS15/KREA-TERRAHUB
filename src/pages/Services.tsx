      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-6 text-white">
          ...
          <FadeIn direction="up" delay={0.2} className="text-center px-4">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 tracking-tight leading-tight uppercase">
              <span className="text-blue-400">Infraestructura</span> y <span className="italic font-light lowercase text-white/90">acabados</span>
              <br className="hidden sm:block" /> de <span className="text-blue-400">excelencia</span>
            </h1>
          </FadeIn>
        </div>
      </section>
              ...
              return (
                ...
                >
                  ...
                  <div className={`absolute left-1/2 top-56 -translate-x-1/2 -translate-y-1/2 z-20`}>
                    <div className={`${colorClass} w-12 h-12 rounded-full flex items-center justify-center shadow-lg border-4 border-white`}>
